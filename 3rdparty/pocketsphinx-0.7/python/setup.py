...
# If there is no /Users/james/SDKs/pocketsphinx-0.7/../sphinxbase-0.7 and friends use pkg-config
if '/Users/james/SDKs/pocketsphinx-0.7/../sphinxbase-0.7' == '' or '/Users/james/SDKs/pocketsphinx-0.7/../sphinxbase-0.7' == '':
    sbconf = pkgconfig('sphinxbase')
    sb_libdirs = sbconf.get('library_dirs', [])
    sb_includes = sbconf.get('include_dirs', [])
else:
    sb_includes = ['/Users/james/SDKs/pocketsphinx-0.7/../sphinxbase-0.7/include',
                   '/Users/james/SDKs/pocketsphinx-0.7/../sphinxbase-0.7/include']
    sb_libdirs = ['/Users/james/SDKs/pocketsphinx-0.7/../sphinxbase-0.7/src/libsphinxbase/.libs']
